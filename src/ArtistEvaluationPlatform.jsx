...
.video-wrap { position: relative; width: 100%; aspect-ratio: 16 / 9; background-color: #000000; border-radius: 0.75rem; overflow: hidden; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.25); border: 1px solid #27272a; margin-top: 0.5rem; margin-bottom: 1.5rem; transition: transform 0.3s ease; transform-origin: center; }
.video-link-cover { position: absolute; bottom: 0; left: 0; width: 280px; height: 44px; background: #000; z-index: 2; pointer-events: none; border-bottom-left-radius: 0.75rem; }
...
.video-controls-title { font-size: 1.5rem; font-weight: 300; color: #ffffff; margin-bottom: 1.5rem; margin-top: 0; }
.video-controls { display: flex; gap: 1.5rem; flex-wrap: wrap; }
.video-control-group { display: flex; gap: 0.5rem; align-items: center; flex-wrap: wrap; }
.video-control-label { color: #71717a; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.05em; font-weight: 500; margin-right: 0.25rem; }
        ...
        <div className="eval-screen">
            ...
            <div className="video-wrap" style={{ transform: `scale(${videoZoom / 100})` }}>
                <iframe
                    ...
                    allowFullScreen
                ></iframe>
                <div className="video-link-cover" />
            </div>
            ...
            <div className="questions-wrap">
                ...
                <div className="question-card">
                    <h2 className="question-title">
                        2. What artifact(s) would you need to change to use this animation?
